...
public final class DesktopApp {
    ...
    private final JFrame frame = new JFrame("Scrcpy for Linux");
    ...
    private DesktopApp() {
        ...
        JLabel title = new JLabel("Scrcpy for Linux");
    ...
    public static void main(String[] args) {
        if (GraphicsEnvironment.isHeadless()) {
            System.err.println("Scrcpy for Linux requires a graphical desktop (DISPLAY or a supported Wayland/XWayland session).");
            System.exit(1);
        }
        SwingUtilities.invokeLater(() -> {
